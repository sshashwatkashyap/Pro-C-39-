...
function setup() {
  ...
  ground = createSprite(displayWidth, displayHeight, displayWidth+2500000000, 15);
  ground.velocityX = -3;
...
function draw() {
  ...
  if(backGround.x===backGround.x/2){

    backGround.x = displayHeight/2;
    backGround.y = displayWidth/2;
